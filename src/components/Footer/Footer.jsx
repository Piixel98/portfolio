export default function Footer({ profile, contact }) {
  ...
  return (
    <footer className="flex flex-wrap items-center justify-between gap-4 border-t border-white/[0.07] px-[5%] py-8">
      <p className="font-mono text-[11px] text-text-muted">{profile.footerText}</p>
      <div className="flex items-center gap-3">
        <a
          ...
          className="grid h-10 w-10 place-items-center rounded-full border border-white/[0.08] bg-white/[0.03] text-[var(--color-link-muted)] transition hover:border-blue-400/40 hover:bg-blue-400/10 hover:text-text"
        >
